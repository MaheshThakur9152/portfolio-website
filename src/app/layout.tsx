  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[400px] bg-primary/20 blur-[120px] -z-10 pointer-events-none opacity-40 animate-pulse hidden md:block"></div>
        <div className="fixed -bottom-20 -left-20 w-[300px] h-[300px] bg-blue-500/10 blur-[100px] -z-10 pointer-events-none rounded-full hidden md:block"></div>
        <div className="fixed -top-20 -right-20 w-[300px] h-[300px] bg-primary/5 blur-[100px] -z-10 pointer-events-none rounded-full hidden md:block"></div>
